...
<div class="container">
	...
	if(get_bloginfo('language') == 'da-DK'):
		echo do_shortcode('[rev_slider alias="about-us-dk"]');
	else:
		echo do_shortcode('[rev_slider alias="about-us"]');
	endif;
	?>
	<?php //echo do_shortcode('[rev_slider alias="about-us"]'); ?>
	...
	<div class="row orderform">
		...
		<div id="summary">
			...
			<div class="data" id="summarydata">
				...
				<div class="row quality visible border">
					...
					<div class="col-md-12 basic q"><?php _e('Basic', 'TBU'); ?>
						<br><strong><?php the_field('Currency'); ?> <?php echo str_replace(".", ",", get_field('Basic_price')); ?>
							/<?php _e('word', 'TBU'); ?></strong></div>
					<div class="col-md-12 pro hidden q"><?php _e('Business', 'TBU'); ?>
						<br><strong><?php the_field('Currency'); ?> <?php echo str_replace(".", ",", get_field('PRO_price')); ?>
							/<?php _e('word', 'TBU'); ?></strong></div>
				</div>
			...
			<div id="response" class=" text-center">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="btn btn-block" id="order-confirmation"><i class="fa fa-print"></i>
							&nbsp;&nbsp;&nbsp;<?php _e('Click here to print order confirmation.', 'TBU'); ?></div>
					</div>

					<div class="col-md-6">
						<div class="btn btn-block" id="reset-form"><i class="fa fa-refresh"></i>
							&nbsp;&nbsp;&nbsp;<?php _e('Click here to start over.', 'TBU'); ?></div>
					</div>
				</div>
			</div>
		...
		<div class="col-md-2 no-conf"></div>

		<div id="orderformwrapper" class="col-md-10">
			...
			<form name="translation-order" id="translation-order" action="#" method="POST">
				...
				<section class="order-block">
					...
					<div class="row flex">
						<div class="col-md-3 selectable" id="q0" rel="free">
							<div class="well">
						...
						<div class="col-md-3  selectable active" id="q1" rel="basic">
							<div class="well">
								<span class="dashicons dashicons-yes"></span>
								<h3><?php _e('Basic translation', 'TBU'); ?></h3>
								<h4><?php the_field('Currency'); ?> <?php echo str_replace(".", ",", get_field('Basic_price')); ?>
									/<?php _e('word', 'TBU'); ?></h4>
						...
						<div class="col-md-3  selectable" id="q2" rel="pro">
							<div class="well">
								<span class="dashicons dashicons-yes"></span>
								<h3><?php _e('Business translation', 'TBU'); ?></h3>
								<h4><?php the_field('Currency'); ?> <?php echo str_replace(".", ",", get_field('PRO_price')); ?>
									/<?php _e('word', 'TBU'); ?></h4>
								<hr>
						...
						<div class="col-md-3" id="q2" rel="pro">
							<div class="well well-white">
								<?php the_field("page_translate_first_box"); ?>
							</div>
							<div class="well well-green">
								<?php the_field("page_translate_second_box"); ?>
							</div>
						</div>
				...
				<section class="order-block">
					...
					<div class="dropzone dz-clickable" id="my-drop">
						...
						<div class="dz-default dz-message">
							<span class="dashicons dashicons-welcome-add-page" style="font-size: 40px; width: 40px;"></span>
							<span><?php _e('or click or drop files here to upload', 'TBU'); ?></span>
						</div>
				...
				<section class="order-block">
					<div class="row">
						<div class="col-md-4"><input type="text" name="ClientName" placeholder="* <?php _e('Name', 'TBU'); ?>" id="name" class="required" />
						</div>
						<div class="col-md-4"><input type="email" name="ClientEmail" placeholder="* <?php _e('Email', 'TBU'); ?>" id="email" class="required" />
						</div>
