				...
				<div class="row">
					<div class="site-navigation-inner col-sm-12">
						<div class="navbar-header">
							...
							<div id="contact">
								<div class="cell">
								<span class="phone"><span class="dashicons dashicons-phone"></span> <?php _e('Call us'); ?>: +45 23 67 42 72</span><br/>
								<span class="email"><span class="dashicons dashicons-email"></span> <?php _e('Write us'); ?>:  <a href="mailto:<?php echo get_option( 'admin_email' ); ?>"><?php echo get_option( 'admin_email' ); ?></a></span>
								</div>
							</div>
						...
						<div class="collapse navbar-collapse navbar-ex1-collapse top-nav">
							<?php translatedbyus_additional_header_menu(); // main navigation ?>
							<?php translatedbyus_header_menu(); // main navigation ?>
