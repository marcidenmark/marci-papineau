	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li>
					<a href="tips-og-triks">Tips &amp; tricks</a>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu megamenu-content" role="menu">
						<li><a href="oversaet-hjemmeside">Oversæt hjemmeside</a></li>
...
<footer>
	<div class="footer-top footer-section">
		<div class="container">
			...
			<h2 class="text-center title">Translated By Us ApS<span>Oversættelsesbureau</span></h2>
			<div class="row info">
				<div class="col-sm-6">
			...
			<div class="row team">
				...
				<div class="col-sm-4">
					...
					<div class="photo">
						...
						<div class="info">
							<h4 class="name">Mads Ingemann Blücher</h4>
			...
			<div class="row">
				<div class="col-xs-12">
					<a href="http://di.dk/DI/dismedlemmer/Pages/Soegmedlem.aspx?query=Translated+By+Us" target="_blank" class="dansk-industri"></a>
				</div>
			</div>
		</div>
	</div>
...
<script async src="assets/js/script.js?v=1"></script>
